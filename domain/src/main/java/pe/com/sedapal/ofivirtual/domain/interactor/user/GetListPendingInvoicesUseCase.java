...
public class GetListPendingInvoicesUseCase extends UseCase<List<PendingInvoices>, GetListPendingInvoicesUseCase.Params> {

    private final InvoicesRepository goInvoicesRepository;

    /**
     * Constructs a {@link GetListPendingInvoicesUseCase    }.
     *
     ...
     */
    @Inject
    GetListPendingInvoicesUseCase(InvoicesRepository poInvoicesRepository, ThreadExecutor poThreadExecutor,
    ...
    @Override
    public Observable<List<PendingInvoices>> buildUseCaseObservable(Params poParams) {
        return goInvoicesRepository.getListPendingInvoices(poParams.nisRad, poParams.pageNum,poParams.pageSize);
    }
