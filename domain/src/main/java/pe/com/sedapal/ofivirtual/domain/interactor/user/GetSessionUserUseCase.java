...
public class GetSessionUserUseCase extends UseCase<SessionUser, Void> {

    private final UserRepository goUserRepository;

    /**
     * Constructs a {@link GetSessionUserUseCase    }.
     *
     ...
     */
    @Inject
    GetSessionUserUseCase(UserRepository poUserRepository, ThreadExecutor poThreadExecutor,
    ...
    @Override
    public Observable<SessionUser> buildUseCaseObservable(Void aVoid) {
        return goUserRepository.obtainSessionUser();
    }
}
