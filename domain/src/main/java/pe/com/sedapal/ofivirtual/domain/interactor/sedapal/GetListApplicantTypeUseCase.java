...
public class GetListApplicantTypeUseCase extends UseCase<List<ApplicantType>, Void> {
     ...
     */
    @Inject
    GetListApplicantTypeUseCase(MasterRepository poMasterRepository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
        super(threadExecutor, postExecutionThread);
        this.goMasterRepository = poMasterRepository;
    }

    @Override
    public Observable<List<ApplicantType>> buildUseCaseObservable(Void aVoid) {
        return goMasterRepository.getListApplicantType();
    }
}
