package pe.com.sedapal.ofivirtual.ui.component.pinEntry;
...
public class PinEntryEditText extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int colorFocused = isInEditMode() ? Color.WHITE : ContextCompat.getColor(context, R.color.pin_normal);
        mColors[1] = colorFocused;

        int colorUnfocused = isInEditMode() ? Color.WHITE : ContextCompat.getColor(context, R.color.pin_normal);
    ...
    protected void onTextChanged(CharSequence text, final int start, int lengthBefore, final int lengthAfter) {
        ...
        if (text.length() != mMaxLength) {
            mOnPinEnteredListener.notValidPin();
        }
