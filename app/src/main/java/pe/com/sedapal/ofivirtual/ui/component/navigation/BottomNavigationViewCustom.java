...
public class BottomNavigationViewCustom extends BottomNavigationView {
    ...
    public BottomNavigationViewCustom setIconVisibility(boolean visibility) {
        /*
...
//                            System.out.println("mIcon.getMeasuredHeight():" + mIcon.getMeasuredHeight());
     ...
     */
    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom setTextVisibility(boolean visibility) {
...
//            System.out.println("mLargeLabel.getMeasuredHeight():" + getFontHeight(mSmallLabelSize));
     ...
     */
    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom enableAnimation(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//                System.out.println("mLargeLabel:" + mLargeLabelSize);
    ...
    @Deprecated
    public BottomNavigationViewCustom enableShiftingMode(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//        mMenuView.updateMenuView();
     ...
     */
    @Deprecated
    public BottomNavigationViewCustom enableItemShiftingMode(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//        mMenuView.updateMenuView();
     ...
     *
     */
    public BottomNavigationViewCustom setCurrentItem(int index) {
     ...
     */
    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom setSmallTextSize(float sp) {
     ...
     */
    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom setLargeTextSize(float sp) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @param sp
     */
    public BottomNavigationViewCustom setTextSize(float sp) {
        setLargeTextSize(sp);
        setSmallTextSize(sp);
        return this;
    }
     ...
     */
    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom setIconSizeAt(int position, float width, float height) {
     ...
     * @param height in dp
     */
    public BottomNavigationViewCustom setIconSize(float width, float height) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @param dpSize  in dp
     */
    public BottomNavigationViewCustom setIconSize(float dpSize) {
     ...
     */
    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom setItemHeight(int height) {
        // 1. get mMenuView
        final BottomNavigationMenuView mMenuView = getBottomNavigationMenuView();
     ...
     */
    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom setTypeface(Typeface typeface, int style) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     */
    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom setTypeface(Typeface typeface) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     */
    public BottomNavigationViewCustom setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        if (mViewPager != null) {
     ...
     * necessary calls back to the provided {@link BottomNavigationViewCustom} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<BottomNavigationViewCustom> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(BottomNavigationViewCustom bnve) {
        ...
        public void onPageSelected(final int position) {
            final BottomNavigationViewCustom bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, BottomNavigationViewCustom bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
...
//            Log.d("onNavigationItemSelecte", "position:"  + position);
    ...
    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom enableShiftingMode(int position, boolean enable) {
        getBottomNavigationItemView(position).setShifting(enable);
        return this;
    }

    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom setItemBackground(int position, int background) {
        getBottomNavigationItemView(position).setItemBackground(background);
        return this;
    }

    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom setIconTintList(int position, ColorStateList tint) {
        getBottomNavigationItemView(position).setIconTintList(tint);
        return this;
    }

    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom setTextTintList(int position, ColorStateList tint) {
     ...
     */
    public BottomNavigationViewCustom setIconsMarginTop(int marginTop) {
     ...
     */
    @SuppressLint("RestrictedApi")
    public BottomNavigationViewCustom setIconMarginTop(int position, int marginTop) {
        /*
