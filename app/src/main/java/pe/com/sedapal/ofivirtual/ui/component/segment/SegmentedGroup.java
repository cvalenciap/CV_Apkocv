package pe.com.sedapal.ofivirtual.ui.component.segment;
...
public class SegmentedGroup extends RadioGroup {
    ...
    private void updateBackground(View view) {
        ...
        stateListDrawable.addState(new int[] {-android.R.attr.state_checked, android.R.attr.state_pressed}, null); //pressedDrawable
