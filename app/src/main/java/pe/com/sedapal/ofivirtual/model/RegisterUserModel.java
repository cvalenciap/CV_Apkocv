...
public class RegisterUserModel {
    ...
    public RegisterUserModel(long nisRad, long referenciaCobro, int idTipoDoc, String numDoc, String apellido1, String apellido2, String nombres, String correo, long telefono1, int aceptaTerminos, int aceptaNotificaciones, String clave) {
        this.nisRad = nisRad;
